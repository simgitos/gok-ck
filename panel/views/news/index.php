    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td><?= $news['mini'] ?></td>
                <td><a href="<?= $news['url'] ?>" target="_blank"><b><?= $news['title_news'] ?></b></a><br>
                    <small>
                        <i class="bi bi-images me-1"></i><a href="galeria.php?cmd=pliki&dir=<?= $news['galery_news'] ?>"><?= $news['galery_news'] ?></a>

                    </small>
                </td>
                <td><?= $news['od'] ?></td>
                <td>
                    <a href="newsy.php?cmd=edit_news&id=<?= $news['id'] ?>" class="btn btn-sm btn-outline-info"><i class="bi bi-pencil-square"></i></a>
                    <a href="newsy.php?cmd=confirm_del_news&id=<?= $news['id'] ?>" class="btn btn-sm btn-outline-danger"><i class="bi bi-trash"></i></a>
                </td>
            </tr>
        <? endforeach ?>
    </tbody>
